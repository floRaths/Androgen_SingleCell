...
Subset_list     <- SplitObject(Sobj_integrated, split.by = "Cluster")
...
for (i in 1:length(Subset_list)) {
  ...
  saveRDS(Subset_list[[i]], paste0("~/mnt/Cluster_SBI_Error_Catch_", levels(Sobj_integrated)[i], ".rds"))
}

saveRDS(Subset_list, "~/mnt/Cluster_Singled_Batch_Integrated_Error_Catch.rds")
