...
Sobj_integrated <- ScaleData(Sobj_integrated, features = all.genes, vars.to.regress = c("nCount_RNA", "percent.mt"), verbose = T)
...
saveRDS(Sobj_integrated, "~/mnt/Nuclei_All_Samples_Merged_All_Genes_Scaled.rds")
