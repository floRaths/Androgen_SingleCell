...
Subset_list     <- SplitObject(Sobj_integrated, split.by = "Group")
...
for (i in 1:length(Subset_list)) {
  ...
  saveRDS(Subset_list[[i]], paste0("~/mnt/Group_Batch_Int_", levels(Sobj_integrated)[i], ".rds"))

}

saveRDS(Subset_list, "~/mnt/List_Groups_Batch_Integrated.rds")
